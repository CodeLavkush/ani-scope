...
function Lists() {
    return (
        <div className='w-screen h-screen overflow-hidden'>
            {/* large screens */}
            <div className='hidden lg:flex bg-primary w-full h-full p-10'>
                <div className='bg-bg w-full h-full rounded-xl grid grid-rows-8'>
                    <div className='row-span-1 flex justify-start items-center px-10'>
            ...
            {/* smaller screens */}
            <div className='lg:hidden flex bg-primary w-full h-full p-10'>
                <div className='bg-bg w-full h-full rounded-xl grid grid-rows-8'>
